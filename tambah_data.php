            ...
            <div class="col-md-6">
                ...
                <!-- <form action="" method="POST"> -->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="halaman" id="halaman" placeholder="halaman" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">cover buku</label>
                        <input type="text" class="form-control" name="cover buku" id="cover buku" placeholder="cover buku" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
